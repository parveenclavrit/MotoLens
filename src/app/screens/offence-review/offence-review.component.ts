...
export class OffenceReviewComponent implements OnInit {
  ...
  constructor(private popoverController: PopoverController,
    ...
    private file: File,
    private socialShareService: SocialSharingService,
  ...
  Location: ${this.locationUrl}`;
    ...
    //   sharingData
    // );
    this.socialSharing.shareViaWhatsApp(message, this.imageSource )
  }
...
this.socialSharing.shareViaTwitter(message, this.imageSource, )
  // Success
    // const sharingData = {
    //   text: message,
    //   files: [this.imageSource],
  ...
  async shareViaFacebook() {
    ...
    this.socialSharing.shareViaFacebook(message, this.imageSource)
    // const sharingUrl = encodeURIComponent(message);
  ...
  async openAppOrFallback(
    ...
    const dataToShare = {
      ...
      lPType: this.lPType,
      extraOffence: this.extraOffence,
      comment: this.comment,
      locationUrl: this.locationUrl
    };
this.socialShareService.setSharedItem(dataToShare);
      let dialogRef = this.dialog.open(SharePopoverComponent, {
        width: "400px",
        height: "200px",
        // maxWidth: "100%",
        data: {},
